...
\begin{frame}{Bulletproofs: just some basic linear algebra}
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\textwidth]{images/lecture_17/meme.jpg}
    \end{figure}
\end{frame}
...
\begin{frame}{Zero-knowledge multiplication}
    ...
    \begin{alertblock}{Problem}
        Prover does not hide $a,b,c$ values so that adversary could potentially learn them if they are not uniformly distributed.
    \end{alertblock}
\end{frame}
...
\begin{frame}{Compression step: illustration}
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\textwidth]{images/lecture_17/compressed.png}
...
\begin{frame}{What's next?}
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\textwidth]{images/lecture_17/ipa_meme.jpg}
    \end{figure}
\end{frame}
