...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{ccX}
        ...
        \hdashline
        \rowcolor{purple!10}\ref{section:bulletproofs} & Bulletproofs & Inner-product argument, Range proofs, Arithmetic circuits proofs \\
        \Xhline{3\arrayrulewidth}
    \end{tabularx}
...
plan to extend it with more topics in the future. 
